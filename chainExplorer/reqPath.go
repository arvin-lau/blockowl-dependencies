...
const (
	...
	getTransactionDetailListByOklink = "/api/v5/explorer/transaction/transaction-fills?chainShortName=%v&txid=%v"
	...
	getLatestBlockHash               = "/api/v5/explorer/solana/get_latest_block_hash"
)
